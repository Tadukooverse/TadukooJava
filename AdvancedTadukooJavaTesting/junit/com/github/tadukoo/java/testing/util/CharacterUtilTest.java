	...
	public CharacterUtilTest(){
		super("""
				...
				.javadoc(EditableJavadoc.builder()
						...
						.version("Alpha v.0.3.1")
						.build())
				.visibility(Visibility.PUBLIC).isFinal()
				...
				.method(EditableJavaMethod.builder()
						...
						.returnType("boolean").name("isUpperCase")
						.parameter("char", "c")
						.line("return c >= 'A' && c <= 'Z';")
						.build())
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								...
								.build())
						.visibility(Visibility.PUBLIC).isStatic()
						.returnType("boolean").name("isLowerCase")
						.parameter("char", "c")
						.line("return c >= 'a' && c <= 'z';")
						.build())
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								...
								.build())
						.visibility(Visibility.PUBLIC).isStatic()
						.returnType("boolean").name("isLetter")
						.parameter("char", "c")
				...
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								...
								.build())
						.visibility(Visibility.PUBLIC).isStatic()
						.returnType("boolean").name("isNumber")
						.parameter("char", "c")
						.line("return c >= '0' && c <= '9';")
						.build())
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								.param("c", "The character to be capitalized")
								.returnVal("The capital version of the given character, or the character itself " +
										"if it's not a letter")
								.build())
						.visibility(Visibility.PUBLIC).isStatic()
						.returnType("char").name("toUpperCase")
						.parameter("char", "c")
				...
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								.param("c", "The character to change to lowercase")
								.returnVal("The lowercase version of the given character, or the character itself " +
										"if it's not a letter")
								.build())
						.visibility(Visibility.PUBLIC).isStatic()
						.returnType("char").name("toLowerCase")
						.parameter("char", "c")
