...
public class UTF16DictionaryTest extends JavaClassParsingTest{
	
	public UTF16DictionaryTest(){
		super("""
				...
				.javadoc(EditableJavadoc.builder()
						.content("Basic {@link Dictionary} class that supports the {@link StandardCharsets#UTF_16 UTF-16} Charset.")
						.author("Logan Ferree (Tadukoo)")
						.version("Alpha v.0.4")
						.build())
				.visibility(Visibility.PUBLIC)
				.className("UTF16Dictionary")
				.superClassName("AbstractDictionary")
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								.content("Constructs a new UTF-16 Dictionary that's empty")
								.build())
						.visibility(Visibility.PUBLIC)
						.returnType("UTF16Dictionary")
						.line("super();")
						.build())
				.method(EditableJavaMethod.builder()
						.javadoc(EditableJavadoc.builder()
								.content("Constructs a new UTF-16 Dictionary that contains the words in the given Map")
								.param("map", "The Map containing valid words for this Dictionary")
								.build())
						.visibility(Visibility.PUBLIC)
						.returnType("UTF16Dictionary")
				...
				.method(EditableJavaMethod.builder()
						...
						.line("return StandardCharsets.UTF_16;")
						.build())
				.build());
	}
}
